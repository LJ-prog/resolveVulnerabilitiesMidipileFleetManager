<template>
  <div>
    ...
    <div class="title-bar row items-center overflow-hidden">
      <q-btn flat icon="fas fa-chevron-left" class="direction-button" style="height: 100%;" @click="onPrev"></q-btn>
      ...
      <q-btn flat icon="fas fa-chevron-right" class="direction-button" style="height: 100%;" @click="onNext"></q-btn>
    </div>
