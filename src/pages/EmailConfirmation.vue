          ...
          <q-card-section>
            <div class="q-pt-lg" id="btwnImgTitle">
              <div class="row justify-center">
                <h4 class="text-h4 text-uppercase q-my-none text-weight-regular" align="center" id="titleMdp"> Merci pour votre inscription !</h4>
              </div>
            </div>
            <div>
              <p>Veuillez confirmer votre e-mail pour terminer l'inscription : <strong>{{ $route.query.email }}</strong></p>
            </div>
          </q-card-section>
